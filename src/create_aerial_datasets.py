...
def take_images(params, name, wait_time):
    ...
    time.sleep(3)
    take_random_images(
        client, f"data/cityenviron/aerial/{name}/train", 2500, wait_time
    )
...
# take_images([(airsim.WeatherParameter.MapleLeaf, 0.5)], "maple_leaf-0.5", 5)
...
take_images([(airsim.WeatherParameter.Rain, 0.5), (airsim.WeatherParameter.Roadwetness, 0.5)], "rain-0.5", 2)
...
take_images([(airsim.WeatherParameter.Snow, 0.5), (airsim.WeatherParameter.RoadSnow, 0.5)], "snow-0.5", 2)
