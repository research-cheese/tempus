...
class ComputerVisionSession:
  ...
  def get_images(self):
    ...
    responses = self.client.simGetImages([
      airsim.ImageRequest("low_res", airsim.ImageType.Scene), # scene vision image in png format
      # airsim.ImageRequest("low_res", airsim.ImageType.DepthPlanar),
      # airsim.ImageRequest("low_res", airsim.ImageType.DepthPerspective),
      # airsim.ImageRequest("low_res", airsim.ImageType.DepthVis),
      # airsim.ImageRequest("low_res", airsim.ImageType.DisparityNormalized),
      airsim.ImageRequest("low_res", airsim.ImageType.Segmentation),
      # airsim.ImageRequest("low_res", airsim.ImageType.SurfaceNormals),
      # airsim.ImageRequest("low_res", airsim.ImageType.Infrared),
      # airsim.ImageRequest("low_res", airsim.ImageType.OpticalFlow),
      # airsim.ImageRequest("low_res", airsim.ImageType.OpticalFlowVis),
    ])
    return responses
  ...
  def get_detections(self):
    return self.client.simGetDetections("", airsim.ImageType.Segmentation)
